			...
			<div class="portlet-body">
				...
				<form novalidate id="add_region_form" role="form" method="post"
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label class="col-md-4 control-label" for="assigneeZone">Investigator Zone
						...
						<div class="col-md-4">
							<div class="form-group">
								<label class="col-md-4 control-label" for="assigneeState">Investigator State 
								<span class="text-danger">*</span>
								</label>
								<div class="col-md-8">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label class="col-md-4 control-label" for="assigneeCity">Investigator City
									<span class="text-danger">*</span>
								</label>
								<div class="col-md-8">
					...
					<div class="row">						
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-4 control-label" for="assigneeName">Investigator Name 
								<span class="text-danger">*</span>
								</label>
								<div class="col-md-8">
					...
					<div class="form-group">
						<div class="col-md-offset-4 col-md-8">
							<input type="hidden" id="regionId" name="regionId"
								value = "">
							<button class="btn btn-info" id="assignInvestigator" type="button">Assign
							</button>
...
//Dropdown Validation
 ...
 $.ajax({
	method:"POST",
	data:formdata,
	url:"${pageContext.request.contextPath}/supervisor/getActiveZone",
 ...
 $("#assigneeState").change(function(){
	 ...
	 $.ajax({
		method:"POST",
		data:formdata,
		url:"${pageContext.request.contextPath}/supervisor/getActiveCity",
		success: function(data)
		{
			if(data == "")
				return;
 ...
 $("#assigneeCity").change(function(){
	 ...
	 $.ajax({
		method:"POST",
		data:formdata,
		url:"${pageContext.request.contextPath}/supervisor/getActiveUser",
		success: function(data)
		{
			if(data == "")
				return;
...
$("#assignInvestigator").click(function(){
